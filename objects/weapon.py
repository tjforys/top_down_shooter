...
class Weapon:
    def __init__(self, bullet_speed: float, shoot_cd: float, shot_amount: int, max_magazine: int, reload_time: float, spread: int, bullet_size: int, shot_speed_spread: float, shoot_type: ShootType, sfx):
...
class Glock(Weapon):
    def __init__(self):
        super().__init__(bullet_speed=2.5, shoot_cd=0, shot_amount=1, max_magazine=10, reload_time=1.5, spread=0, bullet_size=7, shot_speed_spread=0, shoot_type=ShootType.MANUAL,
                         sfx=Music(target_file=FilePaths.mp3_amongus, volume=0.05, loop=False))


class Shotgun(Weapon):
    def __init__(self):
        super().__init__(bullet_speed=1.5, shoot_cd=0.5, shot_amount=3, max_magazine=3, reload_time=3, spread=40, bullet_size=10, shot_speed_spread=0.2, shoot_type=ShootType.MANUAL,
                         sfx=Music(target_file=FilePaths.mp3_amongus, volume=0.05, loop=False))


class AR15(Weapon):
    def __init__(self):
        super().__init__(bullet_speed=3, shoot_cd=0.1, shot_amount=1, max_magazine=30, reload_time=2, spread=0, bullet_size=8, shot_speed_spread=0, shoot_type=ShootType.AUTOMATIC,
                         sfx=Music(target_file=FilePaths.mp3_amongus, volume=0.05, loop=False))
